...
if __name__ == '__main__':
    ...
    benchmark_evolution(EvolutionHandler(*configs_to_benchmark[1]), 8000, sc2, stats_filename='docs/all_256/stats_tournament.txt', fitness_plot_name='docs/all_256/tournament.png')
